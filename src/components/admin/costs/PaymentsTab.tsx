...
import { Plus, Eye, DollarSign, Calendar, CheckCircle, XCircle, Trash2, Clock, Zap } from 'lucide-react';
...
export function PaymentsTab({ payments, isLoading, recentPayments = [] }: PaymentsTabProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {payments.map((payment) => {
          const isRecent = recentPayments.includes(payment.id);
          const isAutoGenerated = payment.notes?.includes('Auto-generated from shift');
