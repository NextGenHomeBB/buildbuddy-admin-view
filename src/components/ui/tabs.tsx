...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 sm:h-10 items-center justify-start sm:justify-center rounded-lg bg-background border border-border p-1 text-muted-foreground overflow-x-auto scrollbar-hide gap-1 sm:gap-2",
      className
    )}
    {...props}
  />
