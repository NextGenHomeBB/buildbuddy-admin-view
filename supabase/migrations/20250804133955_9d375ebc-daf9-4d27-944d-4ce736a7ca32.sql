...
-- Create some sample project phases
INSERT INTO public.project_phases (id, project_id, name, status, start_date, end_date)
VALUES 
  ('00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000001', 'Foundation Work', 'in_progress', '2025-08-01', '2025-08-10'),
  ('00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000001', 'Framing', 'not_started', '2025-08-05', '2025-08-15'),
  ('00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000002', 'Demolition', 'in_progress', '2025-08-03', '2025-08-08')
ON CONFLICT (id) DO NOTHING;
