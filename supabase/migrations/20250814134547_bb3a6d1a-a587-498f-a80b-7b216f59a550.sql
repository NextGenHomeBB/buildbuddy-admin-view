...
-- Create complete secure access system for financial data

-- First, create all the necessary secure functions from scratch
...
-- Create summary function (was missing from previous migration)
...
-- Create admin-only function for system overview
...
-- Grant access to all secure functions
...
-- Ensure the view can be accessed by the secure functions
