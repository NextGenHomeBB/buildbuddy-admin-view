...
DROP POLICY IF EXISTS "Global admins can manage all projects" ON public.projects;
...
-- Create new simplified RLS policies with unique names
...
CREATE POLICY "project_global_admin_policy"
ON public.projects
FOR ALL
TO authenticated
USING (EXISTS (
...
CREATE POLICY "project_org_admin_policy"
ON public.projects
FOR ALL
TO authenticated
USING (
