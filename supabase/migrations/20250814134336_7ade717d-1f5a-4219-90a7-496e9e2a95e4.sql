...
-- Drop existing functions and create clean secure access functions

-- Drop any existing conflicting functions
DROP FUNCTION IF EXISTS public.get_phase_costs_secure;
DROP FUNCTION IF EXISTS public.get_phase_costs_secure(uuid);
DROP FUNCTION IF EXISTS public.get_phase_costs_secure(uuid, text);

-- Create the primary secure function to access phase costs
...
'WARNING: This view contains sensitive financial data. 
...
-- Ensure the view has proper access for the secure functions to work
