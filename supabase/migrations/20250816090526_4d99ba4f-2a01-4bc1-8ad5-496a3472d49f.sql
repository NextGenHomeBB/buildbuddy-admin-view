-- Final fix for assign_workers_to_project function - resolve all column ambiguity issues
...
BEGIN
  ...
  LOOP
    ...
    ON CONFLICT (public.user_project_role.user_id, public.user_project_role.project_id) 
    DO UPDATE SET
      role = EXCLUDED.role,
