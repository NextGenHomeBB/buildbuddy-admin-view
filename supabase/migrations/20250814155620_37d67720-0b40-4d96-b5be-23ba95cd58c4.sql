-- Phase 2: Database Security Hardening - Fix function search paths and create secure access functions

-- 1. Fix search_path for all security-sensitive functions
