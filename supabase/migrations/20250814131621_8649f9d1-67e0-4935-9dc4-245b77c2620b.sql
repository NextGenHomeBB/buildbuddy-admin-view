-- Fix Apple Calendar Credentials Security
...
DROP TRIGGER IF EXISTS audit_apple_credential_access ON apple_calendar_credentials CASCADE;
DROP FUNCTION IF EXISTS audit_credential_access() CASCADE;

-- Drop and recreate the existing policy to ensure clean state
